<template>
    <div>
        <input v-model.trim="value" type="text" placeholder="До" v-bind:class="{ 'bg-danger': hasError }" class="input-cell"/>
    </div>
</template>
    ...
    module.exports = {
        ...
        watch: {
            ...
            value: function (newValue) {
                ...
                this.$store.commit("setProperty", {property: "date_end", value: value});
            }
        },
